namespace RestaurantRater.Constants.Constants
{
    public class Permissions
    {
        ...
        {
            public const string Create = "Permissions.Replies.Create";
            public const string View = "Permissions.Replies.View";
            public const string Edit = "Permissions.Replies.Edit";
            public const string Delete = "Permissions.Replies.Delete";
        }
    }
}